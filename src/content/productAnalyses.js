    ...
    shippedHighlights: [
      {
        label: 'Initial build',
        detail:
          'Committed the first standalone Attend build with the shared inbox, Command Center, tasks, templates, and Twilio route structure.',
