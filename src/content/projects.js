...
import trackTunerBaselinePicker from '../assets/track-tuner/session-compare-baseline-picker.png?shot';
import trackTunerStrengthLapMetrics from '../assets/track-tuner/session-compare-strength-lap-metrics.png?shot';
import trackTunerContextFlags from '../assets/track-tuner/session-compare-context-flags.png?shot';
import trackTunerSetupDeltas from '../assets/track-tuner/session-compare-setup-deltas.png?shot';
import rideSenseOverviewDesktop from '../../docs/assets/readme/overview-desktop.png?shot';
import rideSenseOverviewMobile from '../../docs/assets/readme/overview-mobile.png?shot';
import windCastHero from '../assets/windcast/windcast-hero.png?shot';
import windCastMap from '../assets/windcast/windcast-map.png?shot';
import windCastSpotDetail from '../assets/windcast/windcast-spot-detail.png?shot';
import wattsmithBuilderDashboard from '../assets/wattsmith/wattsmith-01-builder-dashboard.png?shot';
import wattsmithChartTooltip from '../assets/wattsmith/wattsmith-02-chart-tooltip-vo2.png?shot';
import wattsmithLibrary from '../assets/wattsmith/wattsmith-03-workout-library.png?shot';
import wattsmithProfile from '../assets/wattsmith/wattsmith-04-athlete-profile.png?shot';
import wattsmithExport from '../assets/wattsmith/wattsmith-05-export-preview.png?shot';
import wattsmithMobileEditor from '../assets/wattsmith/wattsmith-06-mobile-builder-editor.png?shot';
import wattsmithMobileChart from '../assets/wattsmith/wattsmith-07-mobile-chart-summary.png?shot';
import wattsmithTemplatePreview from '../assets/wattsmith/wattsmith-08-template-preview-modal.png?shot';
import wattsmithCollapsedEditor from '../assets/wattsmith/wattsmith-09-collapsed-workout-blocks.png?shot';
import wattsmithExportReadiness from '../assets/wattsmith/wattsmith-10-export-readiness-checklist.png?shot';
import wattsmithBuilderWorkspace from '../assets/wattsmith/wattsmith-11-builder-workspace.png?shot';
import wattsmithReusableBlockPalette from '../assets/wattsmith/wattsmith-12-reusable-block-palette.png?shot';
import wattsmithWorkoutStepEditor from '../assets/wattsmith/wattsmith-13-workout-step-editor.png?shot';
import oncopathHomeHero from '../assets/oncopath/oncopath-01-home-hero.png?shot';
import oncopathResults from '../assets/oncopath/oncopath-02-results.png?shot';
...
import oasisPersonalBest from '../assets/oasis-race-control/oasis-race-control-04-personal-best.png?shot';
